<?php
    /* 2 Passo: criando a classe tarefa service, criando  o crud */
    ...
    class TarefaService{
        ...
        public function inserir(){
            ...
            $stmt->bindValue(':tarefa', $this->tarefa->__get('tarefa')); //recuperando o valor de tarefa
            $stmt->execute();
        }
        ...
        public function recuperarTarefasPentendetes(){
